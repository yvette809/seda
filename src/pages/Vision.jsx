...
const Vision = () => {
  return (
    ...
    <p className='my-4  vision'><em><FaQuoteLeft className='fa-right mx-3'/> Sustainable ecosystems<br/> with Equitable Distribution of resources for <br/> improved livelihoods within all parts and wholes</em></p>
